...
sns.boxplot(data = scores, x = "Prediction", hue = "Method", y = "MSE", ax = ax[0])
sns.boxplot(data = scores, x = "Prediction", hue = "Method", y = "Pearson", ax = ax[1])
sns.boxplot(data = scores, x = "Prediction", hue = "Method", y = "R2", ax = ax[2])
fig.tight_layout()
...
ax[2].legend(loc='upper left', prop={'size': 15}, frameon = False, ncol = 1, bbox_to_anchor=(1.04, 1), markerscale = 6)
