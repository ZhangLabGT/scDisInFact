...
result_dir = "results_covid/dropout/prediction_oos2/"
...
scores_scdisinfact = pd.read_csv("results_covid/dropout/prediction_oos2/scores.csv", index_col = 0)
...
fig.savefig("results_covid/dropout/prediction_oos2/scores_wo_batcheffect.png", bbox_inches = "tight")
...
ax[1].set_ylim(-0.0, 1.1)
ax[2].set_ylim(-0.0, 1.1)
fig.savefig("results_covid/dropout/prediction_oos2/scores_w_batcheffect.png", bbox_inches = "tight")
