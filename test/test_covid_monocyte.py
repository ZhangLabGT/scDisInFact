...
data_dir = "../data/covid19-scinsight/Monocytes/"
result_dir = "covid-scinsight/Monocytes_raw/"
...
# utils.plot_latent(zs = z_cs_umaps, annos = [x["majorType"].values.squeeze() for x in meta_cells_array], mode = "joint", axis_label = "UMAP", figsize = (15,10), save = (result_dir + comment+"common_dims_celltypes.png") if result_dir else None , markerscale = 6, s = 1, alpha = 0.5, label_inplace = True, text_size = "small")
...
# utils.plot_latent(zs = z_ds_umaps[0], annos = [x["majorType"].values.squeeze() for x in meta_cells_array], mode = "joint", axis_label = "UMAP", figsize = (7,5), save = (result_dir + comment+"diff_dims_celltypes.png".format()) if result_dir else None, markerscale = 6, s = 1, alpha = 0.5)
